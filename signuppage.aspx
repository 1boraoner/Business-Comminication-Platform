<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="signuppage.aspx.cs" Inherits="BCOM.signuppage" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100px" src="images/usergroup.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="Signupbutton" runat="server" Text="Sign Up"  OnClick="Sign_up"/>
                           </div>
                        </center>
                     </div>
                  </div>
